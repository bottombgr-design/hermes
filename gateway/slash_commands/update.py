...
class UpdateCommandsMixin:
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        # NOTE: gateway/slash_commands/update.py sits one directory deeper
        # than the old gateway/slash_commands.py, so reaching the repo root
        # takes one more .parent. Without this, project_root would resolve to
        # gateway/ and /update would silently report "Not a git repository".
