...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("route", "Hybrid routing: auto (classify), or pin to local/cloud", "Configuration",
               cli_only=True, args_hint="[auto|local|cloud|on|off|status]",
               subcommands=("auto", "local", "cloud", "on", "off", "status")),
    CommandDef("local", "Pin upcoming turns to the local model (hybrid routing)", "Configuration",
               cli_only=True),
    CommandDef("cloud", "Pin upcoming turns to the cloud/primary model (hybrid routing)", "Configuration",
               cli_only=True),
