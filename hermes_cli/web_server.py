...
_MESSAGING_ENV_FALLBACKS: dict[str, dict[str, Any]] = {
    ...
    "EMAIL_DISPLAY_NAME": {
        "description": "Display name for the From: header on outgoing mail (e.g. Iris Sloane)",
        "prompt": "Email From display name",
    },
    "EMAIL_ALLOW_ALL_USERS": {
        "description": "When true, accept mail from any sender (prefer a dedicated mailbox)",
        "prompt": "Allow all email senders",
        "advanced": True,
    },
    "EMAIL_HOME_ADDRESS": {
        "description": "Default address for cron / notification delivery",
        "prompt": "Email home address",
    },
    "EMAIL_ALLOWED_USERS": {
