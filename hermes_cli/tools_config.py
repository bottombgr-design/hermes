...
CONFIGURABLE_TOOLSETS = [
    ...
    ("matrix",          "🟩  Matrix Room Tools",      "react, fetch history, set presence"),
    ("matrix_admin",    "🛡️  Matrix Admin Tools",     "redact, invite, create room (gated)"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "matrix", "matrix_admin", "video", "video_gen", "x_search"}
