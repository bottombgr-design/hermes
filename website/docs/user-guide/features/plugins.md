...
| [`pre_model_route`](/user-guide/features/hooks#pre_model_route) | Once per turn, before prompt/API assembly — can select a configured model/provider for that turn only |
