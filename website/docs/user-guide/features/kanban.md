...
- a **deliberate continuation** is newer than the PR link — an `unblock` or an explicit `hermes kanban unguard` (below). Intentional follow-up / rework is exactly what the guard should allow; and
