...
class TestSchemaInit:
    ...
    def test_v23_system_prompts_are_deduped_on_migration(self, tmp_path):
        ...
        # Current main already uses v23 for its FTS storage migration. Prompt
        # deduplication must still run for databases at that exact version.
