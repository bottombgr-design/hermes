...
def resolve_bind_host(config_extra=None) -> str:
    ...
    Config priority: config.extra.host → A2A_HOST env → 127.0.0.1.
    """
    extra = config_extra or {}
    requested = extra.get("host", "").strip() or os.getenv("A2A_HOST", "").strip() or "127.0.0.1"
