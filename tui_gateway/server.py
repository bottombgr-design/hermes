...
def _(rid, params: dict) -> dict:
    ...
    return _ok(
        rid,
        _attach_synchronization(response, sid, _sessions[sid]),
    )
...
def _(rid, params: dict) -> dict:
    ...
    auto_continue = _maybe_schedule_auto_continue(sid, session, target)
    payload = {
        "session_id": sid,
        "resumed": target,
        "message_count": len(messages),
    ...
    return _ok(
        rid,
        _attach_synchronization(payload, sid, session, params.get("cursor")),
    )
