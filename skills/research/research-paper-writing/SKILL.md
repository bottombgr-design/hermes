...
> **📄 Full drafting guide moved to [references/paper-drafting.md](references/paper-drafting.md)** — covers all 12 drafting steps (title, abstract, Figure 1, introduction, methods, experiments, related work, limitations, conclusion, appendix, ethics, datasheets/model cards), the Narrative Principle, two-pass refinement, LaTeX quality checks, writing style guidance, template setup, figure generation with SciencePlots, and page budget management. Load it when you need detailed drafting instructions.

### Quick Reference

| Step | Section | Key Rule |
|------|---------|----------|
| 5.0 | Title | State contribution; 15 words max; include method name |
| 5.1 | Abstract | 5 sentences: what/why/how/evidence/result |
| 5.2 | Figure 1 | Draft before introduction; understandable without reading text |
| 5.3 | Introduction | 1-1.5 pages; include contribution bullets |
| 5.4 | Methods | Enable reimplementation; all hyperparameters listed |
| 5.5 | Experiments | Every experiment states which claim it supports |
| 5.6 | Related Work | Organize methodologically, not paper-by-paper |
| 5.7 | Limitations | Required by all venues; honesty helps |
| 5.8 | Conclusion | Restate contribution differently; no new results |
| 5.9 | Appendix | Unlimited pages; proofs, extra experiments, implementation details |
| 5.10 | Ethics Statement | Positive/negative impact, fairness, compute carbon, LLM disclosure |
| 5.11 | Datasheets/Model Cards | Required for new datasets or model releases |

**Template setup**: Always copy the entire template directory first, verify it compiles as-is, then replace content section by section. See [references/paper-drafting.md](references/paper-drafting.md) for full LaTeX template workflow and figure generation with SciencePlots.
