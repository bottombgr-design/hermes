...
def _usage_get(obj: Any, name: str, default: Any = 0) -> Any:
    """Read a usage field from either SDK objects or raw dict payloads."""
...
def normalize_usage(
    ...
    *,
    ...
    # completion_tokens_details.reasoning_tokens. Use _usage_get so both SDK
    # objects and raw dict payloads from terminal Responses stream events work.
