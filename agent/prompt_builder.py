...
KANBAN_GUIDANCE = (
    ...
    "`kanban_block(kind=\"review_required\", reason=\"What changed: ...; "
    "What should be reviewed: ...; Recommended decision: ...\")` so a "
    "reviewer can approve+unblock or request changes. The review summary "
    "must be concise and must describe what changed, what should be "
    "reviewed, and the recommended decision. Reviewing-then-"
