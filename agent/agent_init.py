...
from agent.copilot_acp_client import is_acp_process_runtime
...
def init_agent(
    ...
    if (
        ...
        and not is_acp_process_runtime(agent.provider, agent.base_url)
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if api_key and base_url:
            ...
            if is_acp_process_runtime(agent.provider, base_url):
