...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "survive the parent session (use cronjob or a tracked background process).\n\n"
        "CONSTRAINTS:\n"
        ...
        "- Leaf children cannot call delegate_task, clarify, memory, or send_message. "
        "Orchestrators retain delegation only when runtime nesting allows it; they "
        "still cannot call clarify, memory, or send_message.\n"
