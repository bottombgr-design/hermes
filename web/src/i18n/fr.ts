...
export const fr: Translations = {
  ...
  profiles: {
    ...
    reasoningInherit: "Hériter de la valeur par défaut du fournisseur",
    reasoningSaved: "Niveau de raisonnement mis à jour",
    reasoningUnset: "valeur par défaut du fournisseur",
  },
