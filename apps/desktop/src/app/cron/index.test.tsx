...
describe('CronView run history cache', () => {
  beforeEach(() => {
    ...
    api.getCronDeliveryTargets.mockResolvedValue([
      { home_env_var: null, home_target_set: true, id: 'local', name: 'This desktop' }
    ])
  ...
  it('invalidates all run-history shapes after deleting a job', async () => {
    ...
    fireEvent.pointerDown(screen.getByRole('button', { name: 'Manage' }), {
      button: 0,
      ctrlKey: false,
      pointerType: 'mouse'
    })
