...
import { $activeSessionId, $currentCwd, $sessions } from '@/store/session'
...
export function LogsPane() {
  ...
  const sessionQueryValue =
    resolvedFilter === LOGS_SESSION_FILTER_ALL
      ? undefined
      : resolvedFilter === LOGS_SESSION_FILTER_CURRENT
