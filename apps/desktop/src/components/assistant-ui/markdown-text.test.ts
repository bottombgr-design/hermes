...
describe('preprocessMarkdown', () => {
  ...
  it('supports angle-bracket file urls with spaces and supplies an empty-alt fallback', () => {
    const path = 'file:///home/user/My Images/iceland.png'
    const output = preprocessMarkdown(`![](<${path}>)`)

    expect(output).toBe(`[Image: iceland.png](#media:${encodeURIComponent(path)})`)
  })
