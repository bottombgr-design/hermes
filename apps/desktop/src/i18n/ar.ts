...
export const ar = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      transportDesc: 'اختر ما إذا كان Desktop يتصل بعنوان البوابة العام مباشرة أو عبر وكيل mTLS محلي.',
      transportDirect: 'مباشر',
      transportLocalMtlsProxy: 'وكيل mTLS محلي',
      effectiveUrlTitle: 'رابط الوكيل المحلي',
      effectiveUrlDesc: 'نقطة النقل المتقدمة التي يستخدمها Desktop فعلياً. يبقى رابط البوابة العام ظاهراً في الإعدادات.',
      ...
      connectedToViaProxy: (publicUrl, effectiveUrl, version) =>
        `متصل بـ ${publicUrl} عبر ${effectiveUrl}${version ? ` · Hermes ${version}` : ''}`,
