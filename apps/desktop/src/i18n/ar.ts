...
export const ar = defineLocale({
  ...
  settings: {
    ...
    model: {
      ...
      delegateTitle: 'نموذج الوكيل الفرعي',
      delegateReset: 'وراثة النموذج الأصلي',
      delegateDesc: 'اختر النموذج المستخدم للمهام المفوضة. تتبع الوراثة نموذج المحادثة الحالي.',
      delegateInheritsParent: 'وراثة نموذج الوكيل الأصلي',
