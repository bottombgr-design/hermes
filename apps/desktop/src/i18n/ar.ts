...
export const ar = defineLocale({
  ...
  billingBlock: {
    ...
    fallbackMessage: 'نفد رصيد حسابك. أضف رصيدا للمتابعة.',
  ...
  settings: {
    ...
    fieldLabels: {
      ...
      'desktop.repoScanExcludePaths': 'مسارات المستودعات المستبعدة',
      ...
      'stt.echoTranscripts': 'إظهار النصوص المفرّغة',
    ...
    fieldDescriptions: {
      ...
      'desktop.repoScanEnabled': 'يفحص المجلدات المحلية بحثًا عن مستودعات Git لعرضها ضمن المشاريع.',
      'desktop.repoScanRoots': 'المجلدات التي سيجري فحصها. اتركها فارغة لفحص مجلد المنزل.',
      'desktop.repoScanExcludePaths': 'المجلدات التي سيُتخطى فحصها مع جميع المجلدات المتفرعة منها.',
    ...
    gateway: {
      ...
      cloudDesc: 'سجّل الدخول مرة واحدة إلى Hermes Cloud واختر من الوكلاء في حسابك — دون لصق أي رابط.',
      cloudSignInTitle: 'Hermes Cloud',
      cloudSignIn: 'تسجيل الدخول إلى Hermes Cloud',
      cloudSignedIn: 'مُسجَّل الدخول إلى Hermes Cloud',
      ...
      sshPortTitle: 'المنفذ',
      sshPortDesc: 'اتركه فارغا لاستخدام المنفذ 22 أو المنفذ المحدد في ~/.ssh/config.',
      ...
      sshReachable: (host, platform) => `يمكن الوصول إلى ${host} على ${platform}، وقد عُثر على Hermes`,
      ...
      sshErrAuth:
        'فشلت مصادقة SSH. حمّل مفتاحك في ssh-agent عبر ssh-add، أو اضبط IdentityFile في ~/.ssh/config — يشغّل Hermes الأمر ssh دون تفاعل.',
      sshErrHostKey:
        'تغير مفتاح المضيف منذ آخر اتصال. تأكد من أن هذا متوقع، ثم شغّل ssh-keygen -R <host> وأعد الاتصال.',
      sshErrNotInstalled:
        'Hermes غير مثبت على الجهاز البعيد. ثبّته هناك (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) أو حدد مسار Hermes.',
      sshErrPlatform: 'نظام الجهاز البعيد غير مدعوم. يدعم وضع SSH في Hermes Desktop مضيفات Linux وmacOS وWindows.',
      sshErrTimeout: 'انتهت مهلة اتصال SSH. قد يكون المضيف غير متاح أو في وضع السكون.',
      sshErrUpdateRequired: 'حدّث Hermes على الجهاز البعيد قبل الاتصال من تطبيق سطح المكتب.',
    ...
    mcp: {
      ...
      tabServers: 'الخوادم',
      tabCatalog: 'الكتالوج',
      catalogLoading: 'جار تحميل كتالوج MCP...',
      ...
      catalogInstallStarted: name => `جار تثبيت ${name}... يسري على الجلسات الجديدة عند الاكتمال.`,
    ...
    model: {
      ...
      fallbackEmpty: 'لا نماذج احتياطية — يُستعمل النموذج الافتراضي ما لم يفشل.',
      notInCatalog: 'ليس في قائمة نماذج هذا المزوّد — قد تلجأ الطلبات إلى نموذج احتياطي.',
      tasks: {
        vision: {
          label: 'الرؤية',
          hint: 'تحليل الصور'
    ...
    sessions: {
      ...
      autoArchiveDesc:
        'يؤرشف تلقائيا المحادثات التي لم تفتحها منذ مدة. المحادثات المثبتة لا تؤرشف أبدا، ولا يُحذف شيء — المؤرشفة تنتقل إلى هنا فقط.',
    ...
    toolsets: {
      ...
      nousAuthNeededTitle: 'تسجيل الدخول إلى Nous Portal',
      nousAuthNeededMessage: provider => `حُفظ ${provider} لكنه لن يعمل قبل تسجيل الدخول إلى Nous Portal.`,
      ...
      loadingModels: 'جار تحميل كتالوج النماذج...',
      ...
      terminalBackend: {
        ...
        loading: 'جار فحص واجهات التنفيذ الخلفية...',
  ...
  skills: {
    ...
    visionModelLink: 'اختيار نموذج الرؤية من الإعدادات ← النماذج',
    ...
    hub: {
      ...
      resultCount: (count, ms) => {
        ...
        return ms !== null ? `${results} خلال ${ms} مللي ثانية` : results
      },
      ...
      installStarted: name => `جار تثبيت ${name}...`,
      uninstallStarted: name => `جار إزالة ${name}...`,
  ...
  starmap: {
    ...
    emptyDesc: 'كلّما بنى Hermes مهاراتٍ وذكرياتٍ لعملك، تظهر هنا.',
  ...
  webhooks: {
    ...
    hint: 'تُطبَّق تغييرات الاشتراكات فورا دون إعادة تشغيل ما دام المستقبِل يعمل. والاشتراكات المعطّلة ترفض الأحداث الواردة.',
    empty: 'لا توجد اشتراكات ويب هوك بعد.',
    disabledTitle: 'مستقبِل الويب هوك معطّل',
    disabledBody:
      'الويب هوك منصة قائمة بذاتها ضمن البوابة. فعّلها هنا لقبول أحداث HTTP الواردة؛ ولا تحتاج قنوات المحادثة إلا حين يسلّم اشتراك إلى Telegram أو Discord أو Slack أو قناة أخرى.',
    enable: 'تفعيل الويب هوك',
    enabling: 'جار التفعيل...',
    enabled: name => `مُفعّل: "${name}"`,
    ...
    deleteTitle: 'حذف الويب هوك',
    deleteDescPrefix: 'سيؤدي هذا إلى إزالة ',
    deleteDescSuffix: ' نهائيا. لا يمكن التراجع عن هذا.',
    deleteFailed: name => `فشل حذف "${name}"`,
    toggleFailed: name => `فشل تحديث "${name}"`,
    newSubscription: 'اشتراك جديد',
    restarting: 'جار إعادة تشغيل البوابة...',
    restartNeeded: 'الويب هوك مفعّل، لكن البوابة ما زالت تحتاج إعادة تشغيل قبل أن يعمل المستقبِل.',
    restartGateway: 'إعادة تشغيل البوابة',
    restartingGateway: 'جار إعادة التشغيل...',
    restartFailed: detail => `فشل إعادة تشغيل البوابة${detail}`,
    enabledRestarting: 'فُعّل الويب هوك، وجار إعادة تشغيل البوابة...',
    all: '(الكل)',
    ...
    fieldDescriptionPlaceholder: 'ما الذي يفعله هذا الويب هوك (اختياري)',
    fieldEvents: 'الأحداث',
    ...
    created: 'تم الإنشاء',
    createFailed: detail => `فشل الإنشاء: ${detail}`,
    copy: 'نسخ',
    deliverOptions: {
      log: 'السجل',
      telegram: 'Telegram',
  ...
  cron: {
    ...
    deliverNeedsHomeChannel: 'اضبط قناة رئيسية أولاً',
    modelLabel: 'النموذج',
    ...
    scriptOnlyEditHint: 'مهمة برمجية فقط (بلا موجّه ذكاء اصطناعي). معرّف المهمة:',
    saveChanges: 'حفظ التغييرات',
    createAction: 'إنشاء',
    tabs: {
      jobs: 'المهام',
    ...
    blueprints: {
      ...
      dialogDesc: 'املأ التفاصيل ثم جدوله.',
      scheduleIt: 'جدولته',
      ...
      emptyDesc: 'لا تتوفر مخططات أتمتة على هذه الخلفية.'
    }
  },
  artifacts: {
    search: 'بحث',
  ...
  install: {
    ...
    setupChoiceDesc: 'اربط هذا التطبيق ببوابة Hermes تشغّلها بالفعل، أو ثبّت Hermes محليا على هذا الحاسوب.',
    connectExistingTitle: 'الاتصال بنسخة Hermes قائمة',
    connectExistingShort: 'اتصال بنسخة قائمة',
    ...
    installLocalDesc: 'نزّل Hermes وأنشئ بيئة Python الخاصة به وشغّل الخلفية على هذا الحاسوب.',
    localStartUnavailable: 'تعذّر بدء التثبيت المحلي. أعد تشغيل Hermes Desktop وحاول مرة أخرى.',
    remoteSetupTitle: 'الاتصال بنسخة Hermes قائمة',
    remoteSetupDesc: 'أدخل رابط بوابتك. سيكتشف Hermes Desktop ما إذا كانت تحتاج رمزًا أو تسجيل دخول من المتصفح.',
    remoteUrlTitle: 'رابط البوابة',
    remoteUrlDesc: 'استخدم الرابط الأساسي لبوابة Hermes، بما في ذلك https:// عندما تكون بعيدة.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'جار كشف مصادقة البوابة...',
    probeError: 'تعذّر الوصول إلى بوابة Hermes هذه.',
    identityProvider: 'مزود الهوية',
    authTitle: 'المصادقة',
    authNeedsOauth: provider => `سجل الدخول عبر ${provider} قبل اختبار هذه البوابة.`,
    authSignedIn: 'اكتمل تسجيل الدخول من المتصفح.',
    connected: 'متصل',
    signIn: 'تسجيل الدخول',
    signInWith: provider => `تسجيل الدخول عبر ${provider}`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `متصل بـ Hermes Cloud عند ${host}، انقر للإدارة`,
  ...
  assistant: {
    ...
    clarify: {
      ...
      lateAnswerHint: 'لم يعد هذا السؤال بانتظار رد. اختر خيارا لصياغته كرسالة متابعة.'
    },
    tool: {
      copyCode: 'نسخ الكود',
